...
function App() {
  ...
  const updateUIForAuth = (isLoggedIn) => {
    ...
    const checkAuth = async () => {
      ...
      if(!token){ 
        ...
        try {
          const response = await axios.get("https://weather-app-rwj5.vercel.app/verify", {
  ...
  // make a variable here along with its usestate that will con
   ...
   const handleCity = async (e) => {
     ...
     const obj = { city };
     try {
       const response = await axios.post("https://weather-app-rwj5.vercel.app/get", obj);
       if (response.data) {
  ...
  const handleSignupSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("https://weather-app-rwj5.vercel.app/signup", obj);
  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("https://weather-app-rwj5.vercel.app/login", obj) ; 
      if(response.data.bool){
  ...
  const handleLogout = async (e) => {
    try {
      axios.post("https://weather-app-rwj5.vercel.app/logout", {}, {
        headers: {
